...
Future<void> setupServiceLocator() async {
  ...
  getIt.registerFactory<PlayerScoresCubit>(() => PlayerScoresCubit(getIt(), getIt()));
  getIt.registerFactory<GameSessionCubit>(() => GameSessionCubit(getIt(), getIt(), getIt()));
  ...
  getIt.registerFactory<ActiveRoomCubit>(() => ActiveRoomCubit(getIt()));
  getIt.registerFactory<GameDetailsCubit>(() => GameDetailsCubit(getIt()));
}
